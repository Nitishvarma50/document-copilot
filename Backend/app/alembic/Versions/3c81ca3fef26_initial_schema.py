...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("display_name", sa.String(length=225), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column("company_name", sa.String(length=225), nullable=False),
        ...
        sa.Column("primary_document", sa.String(length=225), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("section", sa.String(length=225), nullable=False),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "message_id",
            "citation_index",
            name="uq_messages_citations_message_citation",
        ),
    )
    op.create_index(
